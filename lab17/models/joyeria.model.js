...
module.exports = class Joyeria {
  ...
  save() {
    return db.execute(
        `INSERT INTO tropa (id, nombre, material, precio, tipo, imagen, descripcion) 
        VALUES (?, ?, ?, ?, ?)`, 
        [this.id, this.nombre, this.material, this.precio, this.tipo, this.imagen, this.descripcion]);
